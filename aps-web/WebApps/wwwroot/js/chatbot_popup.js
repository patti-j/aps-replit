...
function preloadChat() {
	...
	if (!chatLoaded) {
		chat.innerHTML += '<iframe id="inner-iframe" src="//embed.chatnode.ai/112cdb78-80d5-4b66-837a-55156b39e63e?context=popup" allow="clipboard-read; clipboard-write" width="100%" height="100%" onload="iframeLoaded()" style="border: none; margin: 0px !important;"></iframe>';
