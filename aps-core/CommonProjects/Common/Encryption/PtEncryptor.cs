...
public class PtEncryptor
{
    ...
    /// <summary>
    /// Attempts to encrypt a string. If the string was successfully encrypted the method will return true and out the encrypted string, if not then the method will return false and out the input string as
    /// the text is already unencrypted.
    /// </summary>
    ...
    /// <summary>
    /// Attempts to decrypt a string. If the string was successfully decrypted the method will return true and out the decrypted string, if not then the method will return false and out the input string as
    /// the text is already unencrypted.
    /// </summary>
    /// <param name="a_string">String to decrypt</param>
    /// <param name="o_outputString">Outs the decrypted text if successful, outs the input string if not successful.</param>
