...
{
    private enum EMatchFinderType { BT2, BT4, BT4B }
    ...
    private const int kDefaultDictionaryLogSize = 21; //Larger history size requires more memory
    ...
    private void SetStreams(Stream inStream,
                            Stream outStream,
                            long inSize,
                            long outSize)
    {
