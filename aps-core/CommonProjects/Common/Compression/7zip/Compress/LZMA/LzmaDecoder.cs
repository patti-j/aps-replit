...
public class Decoder : ICoder, ISetDecoderProperties // ,System.IO.Stream
{
    private class LenDecoder
    {
        ...
        private BitTreeDecoder m_HighCoder = new (Base.kNumHighLenBits);
    ...
    private BitTreeDecoder m_PosAlignDecoder = new (Base.kNumAlignBits);
    ...
    private void SetDictionarySize(uint dictionarySize)
    {
        ...
        {
            throw new Exception($"Failed to initialize decompression dictionary using size {dictionarySize}", e);
        }
    }
    ...
    public void Code(Stream inStream,
                     Stream outStream,
                     long inSize,
                     long outSize,
    ...
    public void SetDecoderProperties(byte[] properties)
    {
        ...
        catch (Exception e)
        {
            ...
            throw new Exception($"Failed to set decompression properties. [{sb.ToString().TrimEnd(',', ' ')}]", e);
        }
    }
