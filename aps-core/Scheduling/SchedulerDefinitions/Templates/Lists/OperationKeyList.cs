...
using ListDataType = PT.SchedulerDefinitions.OperationKey;
using ListType = PT.Scheduler.OperationKeyList;
...
/// ListTemplate
/// </summary>
public class OperationKeyList : IPTSerializable
{
    public const int UNIQUE_ID = 204;

    #region IPTSerializable Members
    public OperationKeyList(IReader reader)
    {
