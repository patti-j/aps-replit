...
using ListDataType = PT.SchedulerDefinitions.ResourceKeyExternal;
using ListType = PT.Scheduler.ResourceKeyExternalIdList;
...
/// </summary>
[Serializable]
public class ResourceKeyExternalIdList : IPTSerializable
{
    public const int UNIQUE_ID = 717;

    #region IPTSerializable Members
    public ResourceKeyExternalIdList(IReader reader)
    {
    ...
    public ResourceKeyExternalIdList() { }

    /// <summary>
    /// Creates a Hashtable using the ResourceKeyExternalId as the key.
    /// </summary>
    ...
    {
        public const int UNIQUE_ID = 718;
