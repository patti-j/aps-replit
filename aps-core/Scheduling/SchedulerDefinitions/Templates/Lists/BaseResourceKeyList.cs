...
using ListType = PT.Scheduler.BaseResourceKeyList;
...
/// ListTemplate
/// </summary>
public class BaseResourceKeyList : IPTSerializable
{
    public const int UNIQUE_ID = 385;

    #region IPTSerializable Members
    public BaseResourceKeyList(IReader reader)
    {
