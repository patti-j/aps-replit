...
using ListDataType = PT.SchedulerDefinitions.ManufacturingOrderKey;
using ListType = PT.Scheduler.MOKeyList;
...
/// ListTemplate
/// </summary>
public class MOKeyList : IPTSerializable
{
    public const int UNIQUE_ID = 202;

    #region IPTSerializable Members
    public MOKeyList(IReader reader)
    {
