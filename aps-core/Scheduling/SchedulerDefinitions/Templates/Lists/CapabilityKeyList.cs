...
using ListDataType = PT.APSCommon.BaseId;
using ListType = PT.Scheduler.CapabilityKeyList;
...
/// ListTemplate
/// </summary>
public class CapabilityKeyList : IPTSerializable
{
    public const int UNIQUE_ID = 196;

    #region IPTSerializable Members
    public CapabilityKeyList(IReader reader)
    {
    ...
    public class ListsDontMatchException : ListException
    {
        internal ListsDontMatchException()
            : base("The lists don't match in CapabilityKeyList.") { }
    }
