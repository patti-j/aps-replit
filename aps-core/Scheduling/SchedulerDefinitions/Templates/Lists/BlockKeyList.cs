...
using ListDataType = PT.SchedulerDefinitions.BlockKey;
using ListType = PT.Scheduler.BlockKeyList;
...
/// ListTemplate
/// </summary>
public class BlockKeyList : IPTSerializable
{
    public const int UNIQUE_ID = 194;

    #region IPTSerializable Members
    public BlockKeyList(IReader reader)
    {
