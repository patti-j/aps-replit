...
using ListDataType = PT.Scheduler.BaseActivity;
using ListType = PT.Scheduler.BaseActivityList;
...
/// </summary>
[Serializable]
public class BaseActivityList //, PT.Common.IPTSerializable
{
    public const int UNIQUE_ID = 301;

    //		#region IPTSerializable Members
    //
    //		public BaseActivityList(PT.Common.IReader reader)
    //		{
    ...
    public class ListsDontMatchException : ListException
    {
        internal ListsDontMatchException()
            : base("The lists don't match in BaseActivityList.") { }
    }
