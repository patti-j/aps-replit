...
/// <summary>
/// Transmission for moving an existing CapacityInterval to a new time and/or resource.
/// </summary>
public class CapacityIntervalMoveT : CapacityIntervalIdBaseT, IPTSerializable
{
    public override string Description => "Capacity Interval moved";

    public new const int UNIQUE_ID = 45;

    #region IPTSerializable Members
    public CapacityIntervalMoveT(IReader reader)
        : base(reader)
    {
    ...
    public CapacityIntervalMoveT() { }

    public CapacityIntervalMoveT(BaseId scenarioId,
