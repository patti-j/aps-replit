...
/// <summary>
/// Transmission for copying the specified RecurringCapacityInterval to another resource.
/// </summary>
public class RecurringCapacityIntervalCopyToResourceT : RecurringCapacityIntervalIdBaseT
{
    public new const int UNIQUE_ID = 592;

    #region IPTSerializable Members
    public RecurringCapacityIntervalCopyToResourceT(IReader reader)
        : base(reader)
    {
    ...
    public RecurringCapacityIntervalCopyToResourceT() { }

    public RecurringCapacityIntervalCopyToResourceT(BaseId scenarioId,
    ...
    public override string Description => "Recurring Capacity Interval copied to Resource";
}